...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cylc-flow-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cylc-flow-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cylc-flow cylc-flow-base
# for installing globally
pixi global install cylc-flow cylc-flow-base
```
...
It is possible to list all of the versions of `cylc-flow` available on your platform:
...
```
pixi search cylc-flow --channel conda-forge
```
